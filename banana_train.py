...
# Папки для данных
train_dir = 'dataset/banana/train'
validation_dir = 'dataset/banana/validation'
...
# Сохраняем модель
model.save('banana_classifier-demo.h5')
print("✅ Модель сохранена в banana_classifier-demo.h5")