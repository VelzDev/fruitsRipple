...
# Папки для данных
train_dir = 'dataset/strawberry/train'
validation_dir = 'dataset/strawberry/validation'
...
# Сохраняем модель
model.save('strawberry_classifier-demo.h5')
print("✅ Модель сохранена в strawberry_classifier-demo.h5")